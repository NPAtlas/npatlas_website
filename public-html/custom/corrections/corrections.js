...
function showIncorrectStructure() {
  ...
  if (document.getElementById("otherIncorStrRadio").checked)
    ...
    document
      .getElementById("otherIncorStruText")
...
function showIncorCompName() {
  ...
  if (document.getElementById("otherIncCompNameRadio").checked)
    ...
    document
      .getElementById("otherIncorNameText")
      .setAttribute("readOnly", "readOnly");
...
function showIncorRefer() {
  ...
  if (document.getElementById("incorReferOtherRadio").checked)
    ...
    document
      .getElementById("otherIncorRefer")
      .setAttribute("readOnly", "readOnly");
...
function submitCorrectionsData() {
  var tempSource = "";
  correctionsData.correctionTypeRadio = document.querySelector(
    'input[name="correctionType"]:checked'
  ).value;

  if (correctionsData.correctionTypeRadio == "missingCompound") {
    correctionsData.compoundName = document.getElementById(
      "compoundName"
    ).value;
    correctionsData.correctCitation = document.getElementById(
      "missCompCitation"
    ).value;
    correctionsData.compoundFormula = document.getElementById(
      "compFormula"
    ).value;
    correctionsData.compoundStructure = document.getElementById(
      "compStructure"
    ).value;
  ...
  if (correctionsData.correctionTypeRadio == "incorrectStructure") {
    ...
    correctionsData.compoundStructure = document.getElementById(
      "incorStruCompStructure"
    ).value;
    PicToXMLString("#sketch1", "mol", CBMol);

    correctionsData.correctCompNameRadio = document.querySelector(
      'input[name="incorStrucRadio"]:checked'
    ).value;

    if (correctionsData.correctCompNameRadio == "incorStruOther") {
      correctionsData.correctCompNameRadio = document.getElementById(
        "otherIncorStruText"
      ).value;
      ...
      correctionsData.correctCompNameRadio =
        "Configuration(s) missing/incorrect";
  ...
  if (correctionsData.correctionTypeRadio == "incorrectCompName") {
    ...
    correctionsData.correctCompName = document.getElementById(
      "correctCompName"
    ).value;
    correctionsData.correctCitation = document.getElementById(
      "incorCompNameCitation"
    ).value;
    correctionsData.inCorrectCompoundName = document.getElementById(
      "inCorrectCompoundName"
    ).value;
    correctionsData.correctCompNameRadio = document.querySelector(
      'input[name="incorrectCompNameRadio"]:checked'
    ).value;
  ...
  if (correctionsData.correctionTypeRadio == "incorrectRefer") {
    ...
    correctionsData.correctReferRadio = document.querySelector(
      'input[name="incorrectReferRadio"]:checked'
    ).value;

    if (correctionsData.correctReferRadio == "referOther") {
      correctionsData.correctReferRadio = document.getElementById(
        "otherIncorRefer"
      ).value;
    } else if (correctionsData.correctReferRadio == "referAddIns") {
      correctionsData.correctReferRadio =
        "Additional instance of compound isolation";
      ...
      correctionsData.correctReferRadio =
        "Not the correct original isolation report";
    }
    sendMail(
      correctionsData,
      document.getElementById("username").value,
  ...
  if (correctionsData.correctionTypeRadio == "incorrectTax") {
    ...
    correctionsData.correctGenus = document.getElementById(
      "correctGenus"
    ).value;
    correctionsData.correctTaxRadio = document.querySelector(
      'input[name="incorrectTaxRadio"]:checked'
    ).value;

    if (correctionsData.correctTaxRadio == "incorTaxOther") {
      correctionsData.correctTaxRadio = document.getElementById(
        "otherIncorTax"
      ).value;
      ...
      correctionsData.correctTaxRadio =
        "Isolated concurrently from different sources";
    } else if (correctionsData.correctTaxRadio == "incorIsolation") {
      correctionsData.correctTaxRadio =
        "Not the correct original isolation genus/species";
    }
    sendMail(
      correctionsData,
      document.getElementById("username").value,
...
function compoundNoNameCheckBox() {
  ...
  else document.getElementById("compoundName").removeAttribute("readOnly");
}
