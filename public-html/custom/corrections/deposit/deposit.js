...
function submitForm() {
  ...
  if (table.rows.length > maxIDSmiles) maxLoopComp = table.rows.length;
  compArray = [];
  tempCompObj = {};
  ...
  if (tableOrg.rows.length > maxIDOrg) maxLoopOrg = tableOrg.rows.length;
  tempOrgObj = {};
  orgArray = [];
...
function addRowSmiles(input) {
  ...
  cell.innerHTML =
    '<div><input type="text" autocomplete=off name="value' +
    maxIDSmiles +
    '" style="height:30px; width:100%; margin-bottom: 0px; position: relative;" class="form-control valueClass" id="compName' +
    maxIDSmiles +
    '"/></div>';
  ...
  cell.innerHTML =
    '<div><input type="text" autocomplete=off name="value' +
    maxIDSmiles +
    '" style="height:30px; width:100%; margin-bottom: 0px; position: relative;" class="form-control valueClass" id="smiles' +
    maxIDSmiles +
    '"/></div>';
  ...
  cell.innerHTML =
    '<span id="btA' +
    maxIDSmiles +
    '"class="icon-plus" style="cursor: pointer; margin-top: 10px; margin-right: 14px;" onclick="addRowSmiles(this)" ></span><span id="btD' +
    maxIDSmiles +
    '"class="icon-remove" onclick="remRowSmiles(this)" style="cursor: pointer;" style="margin-top: 10px;">';
}
...
function addRowOrg(input) {
  ...
  cell.innerHTML =
    '<select id="orgType' +
    maxIDOrg +
    '" style="width:100%; background-color:#D9D9D9; height:30px; margin-bottom: 0px;"><option disabled selected value="">Select</option><option value="bacteria">Bacterium</option><option value="fungus">Fungus</option></select>';
  ...
  cell.innerHTML =
    '<div><input type="text" autocomplete=off name="value' +
    maxIDOrg +
    '" style="height:30px; width:100%; margin-bottom: 0px; position: relative;" class="form-control valueClass" id="genus' +
    maxIDOrg +
    '"/></div>';
  ...
  cell.innerHTML =
    '<div><input type="text" autocomplete=off name="value' +
    maxIDOrg +
    '" style="height:30px; width:100%; margin-bottom: 0px; position: relative;" class="form-control valueClass" id="species' +
    maxIDOrg +
    '"/></div>';
  ...
  cell.innerHTML =
    '<span id="btA' +
    maxIDOrg +
    '"class="icon-plus" style="cursor: pointer; margin-top: 10px; margin-right: 14px;" onclick="addRowOrg(this)" ></span><span id="btD' +
    maxIDOrg +
    '"class="icon-remove" onclick="remRowOrg(this)" style="cursor: pointer;" style="margin-top: 10px;">';
}
